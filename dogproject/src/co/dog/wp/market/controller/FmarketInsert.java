...
/**
 * Servlet implementation class FmarketInsert
 */
@WebServlet("/FmarketInsert.do")
public class FmarketInsert extends HttpServlet {
...
//			
			...
			String fpimage = request.getParameter("fpimage");
			...
			market.setFpimage(fpimage);
			market.setFsselect(fsselect);
			market.setFregdt(fregdt);
			
		
			marketDAO.MarketInsert(market);
			response.sendRedirect(request.getContextPath()+"/FmarketView.do");
