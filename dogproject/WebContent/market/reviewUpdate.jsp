...
<script> var tit01="후기쓰기 수정"</script>
...
<div id="sub_content_wrap"  class="sub0203 inner">
	<div class="inner" style="margin-bottom:10em"><!-- skin : basic_voc -->
				<section id="bo_w">
	    <!-- 게시물 작성/수정 시작 { -->
		  	<form action="ReviewUpdate.do" method="post" name="fwrite" id="fwrite" enctype="multipart/form-data">
			   <input type="hidden" name="seq" value="${review.seq}" >
				...
				<div class="bo_w_tit write_div bo_w_info write_div2">
					<span>제목</span>
            		<input type="text" name="title" value="${review.title}" id="title" required="" class="frm_input full_input required" size="50" maxlength="255" placeholder="제목">
				</div>
			
				<div class="write_div  bo_w_info write_div2">
					<span>내용</span>
			        <div style="" class="wr_content">
						<textarea id="content" name="content"  maxlength="65536" style="width: 100%; height: 300px;">${review.content}</textarea>
		            </div>
			    </div>
					...
					<div class="wr_c">
		    		    <div class="bo_w_flie write_div">
			  				<div class="file_wr write_div">
								...
								<input type="file" name="filename" id="filename" class="frm_file" value="${review.filename}">
			 				 </div>
						</div>
		    	  	</div>
				</div>
