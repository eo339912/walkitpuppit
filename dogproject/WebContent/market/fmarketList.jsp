      ...
      <div id="bo_list" style="width:100%" class="sub_board">
       <!-- 게시판 검색 시작 { -->
          <fieldset id="bo_sch">
              ...
              <input type="text" name="id" value="" required="" id="id" class="sch_input" size="25" maxlength="20" placeholder="ID를 입력해주세요">
                       ...
                       <td class="td_num2">${((paging.page-1) * 5 + status.index+1)}</td>
                        ...
                        <td><div class="bo_tit">
									...
									<c:if test="${vo.fsselect == '판매중'}">
										<p class="disti" style="background: #a0d9fb;">나눔중</p>
									</c:if>
									<c:if test="${vo.fsselect == '판매완료'}">
										<p class="disti" style="background: #82bee2;">나눔완료</p>
									</c:if>
                        </div></td>
