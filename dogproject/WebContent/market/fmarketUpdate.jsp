...
<div style="margin-top:11.5px; padding-bottom:15px; font-size:0.9em">
							 &nbsp;&nbsp;<input type="radio" value ="판매중" name="fsselect" <c:if test="${fn:contains(market.fsselect,'판매중')}">checked="checked"</c:if> class="frm_input2"/> 나눔중  &nbsp;&nbsp;
							 &nbsp;&nbsp;<input type="radio" value ="판매완료" name="fsselect" <c:if test="${fn:contains(market.fsselect,'판매완료')}">checked="checked"</c:if> class="frm_input2"/> 나눔완료
					</div>
				</div>
