	...
	<div class="inner" style="margin-bottom:10em">
		...
		<section id="bo_vc">
			...
			<div class="cmt_contents">
			    ...
			    <ul class="bo_vc_act">
					<li><a href="CommentDelete.do?seq=${co.seq}&m_seq=${param.seq}" class="btn_b03">삭제</a></li>
				</ul>
				</c:if>
			</div>
			</article>
		...
		<aside id="bo_vc_w" class="bo_vc_w">
		    <h2>댓글쓰기</h2>
			<form name="fviewcomment" id="fviewcomment" action="MarketView.do?seq=${market.seq}" method="post">
