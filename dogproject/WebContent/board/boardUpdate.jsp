...
<div id="sub_content_wrap"  class="sub0401 inner">
	<div class="inner" style="margin-bottom:10em"><!-- skin : basic_voc -->
		<section id="bo_w">
	    <!-- 게시물 작성/수정 시작 { -->
		  	<form action="BoardUpdate.do" method="post" enctype="multipart/form-data" name="fwrite" id="fwrite">
				...
				<div class="bo_w_tit write_div bo_w_info write_div2">
					<span>제목</span>
            		<input type="text" name="title" value="${board.title}" id="title" required="" class="frm_input full_input required" size="50" maxlength="255" placeholder="제목">
				</div>
				...
				<div class="write_div  bo_w_info write_div2">
			        ...
			        <div style="" class="wr_content">
						<textarea id="content" name="content" maxlength="65536" style="width: 100%; height: 300px;">${board.content}</textarea>
		            </div>
			    </div>
