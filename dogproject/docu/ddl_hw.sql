...
CONSTRAINT comments_FK FOREIGN KEY (pseq) REFERENCES park(seq) on delete cascade
)
...
CONSTRAINT w_seq_FK FOREIGN KEY (p_seq) REFERENCES park(seq) on delete cascade
);
...
CONSTRAINT message_FK FOREIGN KEY (m_id) REFERENCES member(id) on delete cascade
);
